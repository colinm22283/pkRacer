...
{
    SDL_SetRenderDrawColor(Engine::renderer, Render::c.r, Render::c.g, Render::c.b, Render::c.a);
    SDL_RenderClear(Engine::renderer);
}
void Render::clearScreen(color c)
{
    SDL_SetRenderDrawColor(Engine::renderer, c.r, c.g, c.b, c.a);
    SDL_RenderClear(Engine::renderer);
}
...
void Render::drawText(int x, int y, TTF_Font* font, std::string str)
{
    ...
    SDL_Texture* tex = SDL_CreateTextureFromSurface(Engine::renderer, textSurface);
    int w = textSurface->w;
    int h = textSurface->h;
    ...
    SDL_RenderCopy(Engine::renderer, tex, NULL, &rect);
}
